      ...
      <div className="container">
        <div className="footer-columns">
          ...
          <div className="footer-column footer-contact">
            ...
            <div className="contact-info">
              <div className="contact-item">
                ...
                <span className="contact-value">47 W 47th St Booth 19/20, New York, NY, 10036</span>
              </div>
              <div className="contact-item">
                <span className="contact-label">Factory:</span>
                <span className="contact-value">151 W 46th Street Fourth Floor New York, NY, 10036</span>
              </div>
              <div className="contact-item">
                <span className="contact-label">Phone:</span>
                <a href="tel:1-212-869-9525" className="contact-value contact-link">
                  1-212-869-9525
                </a>
              </div>
              <div className="contact-item">
                <span className="contact-label">Fax:</span>
                <span className="contact-value">1-212-869-9527</span>
              </div>
              <div className="contact-item">
                <span className="contact-label">Email:</span>
                <a href="mailto:admdenova1@gmail.com" className="contact-value contact-link">
          ...
          <div className="footer-column footer-hours">
            ...
            <p className="hours-text">Monday – Friday 9:00 AM – 5:00 PM</p>
          </div>
        </div>
